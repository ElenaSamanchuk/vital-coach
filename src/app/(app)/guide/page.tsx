      ...
      <div className="space-y-4 pb-8">
        <Card title="Единая система питания" subtitle="Синтез подходов с доказательной базой">
          <div className="text-[13px] space-y-3">
            <p><strong>Средиземноморский:</strong> овощи, рыба, оливковое — сердце, ИР, воспаление.</p>
            <p><strong>Low-GI + carb timing:</strong> при ИР/СПКЯ — крахмал днём, порядок еды, ходьба после.</p>
            <p><strong>High-protein deficit:</strong> 1,6–1,8 г/кг — мышцы и сытость в дефиците.</p>
            <p><strong>Thyroid-aware:</strong> йод, белок, не &lt;1500 ккал, тироксин натощак.</p>
            <p><strong>Cortisol-aware:</strong> сон, без ежедневного HIIT, «минимальный день» при стрессе.</p>
            <p><strong>Cycle-synced:</strong> 4 фазы — разные шаблоны в коуче (меню на выбор).</p>
          </div>
        </Card>
