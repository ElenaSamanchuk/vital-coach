...
export const UI = {
  ...
  onboardingSlides: [
    {
      title: "Сегодня — выбор без давления",
      desc: "Еда и движение на день. Без жёстких диет и чувства вины.",
    },
    {
      title: "Дневник — 2 минуты вечером",
      desc: "Настроение, вода, сон, вес. Один раз — и день закрыт.",
    },
    {
      title: "Прогресс — серия и динамика",
      desc: "Кольца привычек, рекомендации и графики из твоих записей.",
    },
  ] as const,
  ...
  todayRoleHint: "Сегодня — выбираешь еду и движение. Вода, сон и шаги — в Дневнике.",
  diaryRoleHint: "Дневник — итог дня: настроение, вода, сон, вес. Не дублируй ввод в двух местах.",
...
export const APP_FLOW = {
  ...
  note: "Нет входа по паролю. Данные на устройстве — один поток дня без суеты.",
} as const;
