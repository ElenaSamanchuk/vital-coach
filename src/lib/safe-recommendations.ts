...
export const SUPPLEMENT_CAUTIONS: SafeItem[] = [
  ...
  },
  {
    ...
    title: "Витамин D",
    category: "supplement",
    whySafe: "По анализу 25(OH)D; доза с врачом",
  ...
  },
  {
    ...
    caution: "Если анализ низкий несмотря на приём — ФГДС, форма метилкобаламин",
    tags: ["labs-first", "absorption"],
  },
  {
    id: "multivitamin",
    ...
    category: "supplement",
    whySafe: "Не заменяют еду и анализы",
    evidence: "USPSTF — нет пользы для здоровых без дефицитов",
    caution: "Может маскировать дефицит B12/D; сначала анализы",
    tags: ["avoid-blind"],
  },
];
