...
export const WORKOUT_OPTIONS: Record<string, WorkoutOption[]> = {
  ...
  mindbody: [
    ...
    },
    {
      id: "park-walk",
      type: "walk",
      title: "Парк / лес — прогулка 45 мин",
      durationMin: 45,
      intensity: "low",
      moodBoost: "Зелень снижает кортизол",
      leisureNote: "Ecotherapy — настроение +15%",
      caloriesNote: "Шаги к цели дня",
      tags: ["outdoor", "cortisol-safe", "minimum-day"],
    },
    {
      id: "beach-walk",
      type: "walk",
      title: "Пляж / набережная 50 мин",
      durationMin: 50,
      intensity: "low",
      moodBoost: "Морской воздух + солнце",
      leisureNote: "Лёгкое кардио без зала",
      caloriesNote: "Песок — чуть больше расход",
      tags: ["outdoor", "leisure"],
    },
    {
      id: "steps-10k",
      type: "walk",
      title: "10 000 шагов — цель дня",
      durationMin: 75,
      intensity: "low",
      moodBoost: "Привычка важнее интенсивности",
      leisureNote: "Можно разбить на 3 прогулки",
      caloriesNote: "Базовый расход без перегруза",
      tags: ["minimum-day", "ir-benefit"],
    },
    {
      id: "run-easy",
      type: "walk",
      title: "Лёгкий бег / бег-трусца 25 мин",
      durationMin: 25,
      intensity: "moderate",
      moodBoost: "Эндорфины после пробежки",
      leisureNote: "Только при энергии 6+",
      caloriesNote: "Интервалы не нужны",
      tags: ["cardio", "quick"],
    },
  ],
  rest: [
