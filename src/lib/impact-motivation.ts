...
const LEISURE_IMPACT: Record<string, ImpactLabel> = {
  ...
  tea: { effect: "Пауза без экрана", target: "Парасимпатика", horizon: "10 мин" },
  lake: { effect: "Вода успокаивает", target: "Нервная система", horizon: "40 мин" },
  parents: { effect: "Связь с близкими", target: "Окситоцин", horizon: "настроение ↑" },
  cafe: { effect: "Смена обстановки", target: "Дофамин", horizon: "1–2 ч" },
  projector: { effect: "Уют без выхода", target: "Отдых", horizon: "вечер" },
  park: { effect: "Зелень снижает стресс", target: "Кортизол ↓", horizon: "30 мин" },
  beach: { effect: "Морской воздух + солнце", target: "Энергия", horizon: "полдня" },
  museum: { effect: "Новые впечатления", target: "Мозг", horizon: "2–3 ч" },
  craft: { effect: "Поток и радость", target: "Творчество", horizon: "45 мин" },
  volunteer: { effect: "Смысл и связь", target: "Настроение", horizon: "2 ч" },
  chess: { effect: "Стратегия и фокус", target: "Мозг", horizon: "2×/нед" },
  ...
  draw: { effect: "Поток и самовыражение", target: "Творчество", horizon: "45 мин" },
  movie: { effect: "Переключение без усилия", target: "Отдых", horizon: "вечер" },
  music: { effect: "Эмоции через звук", target: "Настроение", horizon: "30 мин" },
  travel: { effect: "Новые впечатления", target: "Батарейка", horizon: "на неделю" },
  pets: { effect: "Окситоцин и спокойствие", target: "Стресс ↓", horizon: "20 мин" },
};
