...
CREATE TABLE "Examination" (
    ...
    CONSTRAINT "Examination_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE "new_Profile" (
    ...
    "onboardingVersion" INTEGER NOT NULL DEFAULT 2,
    "updatedAt" DATETIME NOT NULL,
    CONSTRAINT "Profile_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
INSERT INTO "new_Profile" ("b12Deficiency", "bigFiveScores", "birthYear", "calorieTarget", "carbTargetG", "careerGoal", "coreValuesJson", "cortisolIssues", "currentWeightKg", "cycleLength", "endometriosis", "fatTargetG", "fiberTargetG", "financeGoal", "heightCm", "hormoneIssues", "hypothyroidism", "id", "ikigaiJson", "insulinResistance", "intellectFavorites", "lastPeriodStart", "leisureFavorites", "name", "occupation", "onboardingDone", "otherMedications", "pcosSuspected", "permaScores", "proteinTargetG", "relationshipStatus", "ryffScores", "sdtScores", "sleepTargetMin", "surgeryDate", "surgeryRecovery", "targetChestCm", "targetHipsCm", "targetWaistCm", "targetWeightKg", "thyroidMedication", "unlockedAchievements", "updatedAt", "userId", "vitaminAbsorption", "vitaminDDeficiency", "waterTargetMl", "weeklyReviewJson", "wheelScores", "who5Scores", "workActivityLevel", "xpBalance", "xpBody", "xpCareer", "xpEnergy", "xpFinance", "xpFuel", "xpMind", "xpRelations", "xpSoul") SELECT "b12Deficiency", "bigFiveScores", "birthYear", "calorieTarget", "carbTargetG", "careerGoal", "coreValuesJson", "cortisolIssues", "currentWeightKg", "cycleLength", "endometriosis", "fatTargetG", "fiberTargetG", "financeGoal", "heightCm", "hormoneIssues", "hypothyroidism", "id", "ikigaiJson", "insulinResistance", "intellectFavorites", "lastPeriodStart", "leisureFavorites", "name", "occupation", "onboardingDone", "otherMedications", "pcosSuspected", "permaScores", "proteinTargetG", "relationshipStatus", "ryffScores", "sdtScores", "sleepTargetMin", "surgeryDate", "surgeryRecovery", "targetChestCm", "targetHipsCm", "targetWaistCm", "targetWeightKg", "thyroidMedication", "unlockedAchievements", "updatedAt", "userId", "vitaminAbsorption", "vitaminDDeficiency", "waterTargetMl", "weeklyReviewJson", "wheelScores", "who5Scores", "workActivityLevel", "xpBalance", "xpBody", "xpCareer", "xpEnergy", "xpFinance", "xpFuel", "xpMind", "xpRelations", "xpSoul" FROM "Profile";
DROP TABLE "Profile";
