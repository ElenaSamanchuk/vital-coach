...
INSERT INTO "new_DailyLog" ("calories", "carbsG", "chestCm", "cortisolFeeling", "createdAt", "cycleDay", "cyclePhase", "date", "energy", "fatG", "fiberG", "hipsCm", "id", "intellectJson", "leisureJson", "leisureMinutes", "mealChoices", "mood", "notes", "postMealWalks", "proteinG", "sleepMinutes", "sleepQuality", "stress", "supplementsTaken", "thyroidMedOnTime", "thyroidMedTaken", "updatedAt", "userId", "waistCm", "waterMl", "weightKg", "workoutChoice") SELECT "calories", "carbsG", "chestCm", "cortisolFeeling", "createdAt", "cycleDay", "cyclePhase", "date", "energy", "fatG", "fiberG", "hipsCm", "id", "intellectJson", "leisureJson", "leisureMinutes", "mealChoices", "mood", "notes", "postMealWalks", "proteinG", "sleepMinutes", "sleepQuality", "stress", "supplementsTaken", "thyroidMedOnTime", "thyroidMedTaken", "updatedAt", "userId", "waistCm", "waterMl", "weightKg", "workoutChoice" FROM "DailyLog";
DROP TABLE "DailyLog";
...
INSERT INTO "new_Profile" ("b12Deficiency", "birthYear", "calorieTarget", "carbTargetG", "cortisolIssues", "currentWeightKg", "cycleLength", "endometriosis", "fatTargetG", "fiberTargetG", "heightCm", "hormoneIssues", "hypothyroidism", "id", "insulinResistance", "intellectFavorites", "lastPeriodStart", "leisureFavorites", "name", "occupation", "onboardingDone", "otherMedications", "pcosSuspected", "proteinTargetG", "sleepTargetMin", "surgeryDate", "surgeryRecovery", "targetChestCm", "targetHipsCm", "targetWaistCm", "targetWeightKg", "thyroidMedication", "unlockedAchievements", "updatedAt", "userId", "vitaminAbsorption", "vitaminDDeficiency", "waterTargetMl", "workActivityLevel", "xpBalance", "xpBody", "xpEnergy", "xpFuel", "xpMind", "xpSoul") SELECT "b12Deficiency", "birthYear", "calorieTarget", "carbTargetG", "cortisolIssues", "currentWeightKg", "cycleLength", "endometriosis", "fatTargetG", "fiberTargetG", "heightCm", "hormoneIssues", "hypothyroidism", "id", "insulinResistance", "intellectFavorites", "lastPeriodStart", "leisureFavorites", "name", "occupation", "onboardingDone", "otherMedications", "pcosSuspected", "proteinTargetG", "sleepTargetMin", "surgeryDate", "surgeryRecovery", "targetChestCm", "targetHipsCm", "targetWaistCm", "targetWeightKg", "thyroidMedication", "unlockedAchievements", "updatedAt", "userId", "vitaminAbsorption", "vitaminDDeficiency", "waterTargetMl", "workActivityLevel", "xpBalance", "xpBody", "xpEnergy", "xpFuel", "xpMind", "xpSoul" FROM "Profile";
DROP TABLE "Profile";
