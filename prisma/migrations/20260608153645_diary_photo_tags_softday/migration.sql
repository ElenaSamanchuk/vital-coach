...
CREATE TABLE "new_DailyLog" (
    ...
    "softDay" BOOLEAN NOT NULL DEFAULT false,
    "dayPhoto" TEXT NOT NULL DEFAULT '',
    "dayTagsJson" TEXT NOT NULL DEFAULT '[]',
    "leisureJson" TEXT NOT NULL DEFAULT '[]',
    "intellectJson" TEXT NOT NULL DEFAULT '[]',
    "leisureMinutes" INTEGER,
    "lifeActionsJson" TEXT NOT NULL DEFAULT '{}',
    "workSatisfaction" INTEGER,
...
INSERT INTO "new_DailyLog" ("calories", "carbsG", "chestCm", "cortisolFeeling", "createdAt", "cycleDay", "cyclePhase", "date", "energy", "fatG", "fiberG", "hipsCm", "id", "intellectJson", "leisureJson", "leisureMinutes", "lifeActionsJson", "mealChoices", "mood", "notes", "postMealWalks", "proteinG", "sleepMinutes", "sleepQuality", "stress", "supplementsTaken", "thyroidMedOnTime", "thyroidMedTaken", "updatedAt", "userId", "waistCm", "waterMl", "weightKg", "workSatisfaction", "workoutChoice") SELECT "calories", "carbsG", "chestCm", "cortisolFeeling", "createdAt", "cycleDay", "cyclePhase", "date", "energy", "fatG", "fiberG", "hipsCm", "id", "intellectJson", "leisureJson", "leisureMinutes", "lifeActionsJson", "mealChoices", "mood", "notes", "postMealWalks", "proteinG", "sleepMinutes", "sleepQuality", "stress", "supplementsTaken", "thyroidMedOnTime", "thyroidMedTaken", "updatedAt", "userId", "waistCm", "waterMl", "weightKg", "workSatisfaction", "workoutChoice" FROM "DailyLog";
DROP TABLE "DailyLog";
